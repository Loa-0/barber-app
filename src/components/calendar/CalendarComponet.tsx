...
export const Calendar = () => {
  GoogleSignin.configure({
    ...
    webClientId:
      '685556051749-94tc9vnciflm619semreu9msgv160cvv.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
...
//   }
//   render() {
//     const {monthText, pickDate, days} = this.state;
//     return (
//       <View style={s.main}>
...
//             <View style={s.timeList.main}>{hourList.map(this.renderHour)}</View>
...
//         <AddModal ref={ref => (this.addTaskModal = ref)} />
...
//           this.handleUpdateTask(task, taskIndex, index)
//         }
//       />
//     );
//   };
...
//     this.timelineHeader?.scrollToOffset({
